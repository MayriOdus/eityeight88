	...
	<div id="header">
		...
		<div class="col-md-10 hright">
			...
			<ul class="hoption">
				...
				<li>
					<a href="#" class="hsc">(0) <?=_CART;?></a><a href="#"><?=_PAYMENT_NOTE;?></a>
				</li>
