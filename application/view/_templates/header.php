								...
								<ul class="qtrans_social_chooser" id="qtranslate-chooser">
									...
									<li class="active" style="border:none;">
										...
										<a href="#" data-toggle="modal" data-target=".soci-line" class="btn btn-social-icon btn-twitter">
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 377.764 377.764" enable-background="new 0 0 377.764 377.764" xml:space="preserve" style="width: 15px; margin-top: 2px;">
