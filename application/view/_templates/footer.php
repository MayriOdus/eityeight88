		...
		<p class="footer-links">
			<ul class="social-network social-circle ">
				...
				<li>
					...
					<a href="http://line.me/ti/p/@VER.88OFFICIAL" target="_blank" class="icoLine" title="Line" style="background-color: #ffffff; vertical-align: middle;">
						<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_2" x="0px" y="0px" viewBox="0 0 377.764 377.764" enable-background="new 0 0 377.764 377.764" xml:space="preserve">
				...
				<li><a href="https://instagram.com/ver88official/"  target="_blank" class="icoInstragram" title="Google +"><i class="fa fa-instagram"></i></a></li>
				<li><a href="https://www.youtube.com/channel/UCchLAlGdRStLn5RolkZeWaw/feed"  target="_blank" class="icoGoogle" title="Youtube"><i class="fa fa-youtube-play"></i></a></li>
			</ul>
		</p>

		<p class="footer-company-name">
			© <script>document.write(new Date().getFullYear())</script>, 88(THAILAND) CO., LTD. ALL RIGHTS RESERVED.
		</p>
